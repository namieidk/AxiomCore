  ...
  return (
    <main className="h-screen w-full flex bg-[#020617] text-slate-200 overflow-hidden font-sans uppercase">
      ...
      <section className="flex-1 flex flex-col overflow-y-auto bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-indigo-900/10 via-[#020617] to-[#020617] scrollbar-hide">
        ...
        <header className="px-6 lg:px-10 py-8 flex flex-col lg:flex-row lg:items-end justify-between border-b border-indigo-500/10 backdrop-blur-md sticky top-0 z-20 gap-6 bg-[#020617]/80">
          <div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            {/* DATE INPUTS - Responsive width */}
            <div className="flex items-center bg-white/5 border border-white/10 rounded-2xl px-4 py-2 gap-3 focus-within:border-indigo-500/50 transition-all w-full sm:w-auto justify-between">
              <div className="flex flex-col">
                ...
                <input 
                  ...
                  className="bg-transparent text-[10px] font-bold outline-none text-white w-24 sm:w-28 uppercase"
                />
              </div>
        ...
        <div className="p-4 lg:p-10 max-w-[1600px] w-full mx-auto pb-32 lg:pb-10">
